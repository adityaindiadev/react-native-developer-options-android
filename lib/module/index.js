...
const DeveloperOptionsAndroid = NativeModules.DeveloperOptionsAndroid ? NativeModules.DeveloperOptionsAndroid : new Proxy({}, {
  get() {
...
export async function isDeveloperOptionsEnabled(handleResult) {
